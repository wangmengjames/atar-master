...
A tilemaker wants to make square tiles of size 20 cm $\times$ 20 cm. The front surface is painted with two colours meeting these conditions:
...
\begin{itemize}[nosep]
  ...
  \item $u' = -\sin(x)$, $v' = e^x$.
  \item $f'(x) = \frac{-e^x\sin(x) - e^x\cos(x)}{e^{2x}}$.
  \item Simplify: $f'(x) = -\frac{\sin(x) + \cos(x)}{e^x}$.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item Expand: $\int_0^1 f(x)(2f(x) - 3)\,dx = \int_0^1 2[f(x)]^2 - 3f(x)\,dx$.
  \item Split: $= 2\int_0^1 [f(x)]^2\,dx - 3\int_0^1 f(x)\,dx$.
  \item Substitute: $= 2 \times \frac{1}{5} - 3 \times \frac{1}{3} = \frac{2}{5} - 1 = -\frac{3}{5}$.
\end{itemize}
...
\begin{itemize}[nosep]
  ...
  \item Check $\frac{4+k}{-1}$: For $k = -3$: $\frac{1}{-1} = -1$ and $\frac{-3}{3} = -1$ \checkmark{}. For $k = -5$: $\frac{-1}{-1} = 1$ and $\frac{-5}{3} \neq 1$ ✗.
  \item Therefore $k = -3$.
\end{itemize}
...
\begin{itemize}[nosep]
  ...
  \item Range of $g$: $[-1, 3]$, endpoints correct.
\end{itemize}
...
\begin{itemize}[nosep]
  ...
  \item $2k = \frac{\pi}{6},\, \frac{5\pi}{6},\, \frac{13\pi}{6},\, \frac{17\pi}{6}$ (for $2k \in [0, 4\pi]$).
  \item $k = \frac{\pi}{12},\, \frac{5\pi}{12},\, \frac{13\pi}{12},\, \frac{17\pi}{12}$.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item $g(x)$ is defined on $[0, 2\pi]$, and $h(x - \frac{\pi}{2}) + 2 = g(x)$.
  \item So $h$ is evaluated at $x - \frac{\pi}{2}$ for $x \in [0, 2\pi]$.
  \item Domain of $h$: $[0 - \frac{\pi}{2},\, 2\pi - \frac{\pi}{2}] = [-\frac{\pi}{2},\, \frac{3\pi}{2}]$.
\end{itemize}
...
\begin{itemize}[nosep]
  ...
  \item $= \left[-\frac{40}{\pi}\cos(\frac{\pi x}{10}) + ax\right]_0^{20} = -\frac{40}{\pi}(\cos(2\pi) - \cos(0)) + 20a = 0 + 20a = 20a$.
  \item For Condition 1: $20a = 200$, so $a = 10$.
\end{itemize}
...
\begin{itemize}[nosep]
  ...
  \item $= \left[-\frac{x^4}{400} + \frac{x^3}{10} - x^2 + 10x\right]_0^{20}$.
  \item $= -\frac{160000}{400} + \frac{8000}{10} - 400 + 200 = -400 + 800 - 400 + 200 = 200$.
  \item Since $200 = \frac{1}{2} \times 400$, Condition 1 is met.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item Since $\int_0^k f(x)\,dx = A(k) = k\sin(k)$, by the Fundamental Theorem of Calculus: $f(k) = A'(k)$.
  \item $A'(k) = \sin(k) + k\cos(k)$.
...
\begin{itemize}[nosep]
  ...
  \item Maximise $\sin(k)$ for $k \in [0, 2]$: maximum at $k = \frac{\pi}{2} \approx 1.571$.
  \item Since $\frac{\pi}{2} \in [0, 2]$, the maximum average value occurs at $k = \frac{\pi}{2}$.
\end{itemize}
