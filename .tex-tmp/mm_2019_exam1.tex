...
\begin{itemize}[nosep]
  ...
  \item $f'(x) = -1 \cdot 3 \cdot (3x-1)^{-2} = \frac{-3}{(3x-1)^2}$.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item Quotient rule: $g'(x) = \frac{\pi\cos(\pi x)(x+1) - \sin(\pi x)}{(x+1)^2}$.
  \item $g'(1) = \frac{\pi\cos(\pi)(2) - \sin(\pi)}{4} = \frac{\pi(-1)(2) - 0}{4} = \frac{-2\pi}{4} = -\frac{\pi}{2}$.
\end{itemize}
...
\begin{itemize}[nosep]
  ...
  \item For $x \in [-2\pi, \pi]$: $\frac{x}{2} \in [-\pi, \frac{\pi}{2}]$.
  \item $\frac{x}{2} = \frac{\pi}{3} \implies x = \frac{2\pi}{3}$; $\frac{x}{2} = -\frac{\pi}{3} \implies x = -\frac{2\pi}{3}$.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item $\int_{-1}^{0} \left(\frac{2}{(x-1)^2} + 1\right) dx = \left[-\frac{2}{x-1} + x\right]_{-1}^{0}$.
  \item At $x = 0$: $-\frac{2}{-1} + 0 = 2$.
  \item At $x = -1$: $-\frac{2}{-2} + (-1) = 1 - 1 = 0$.
  \item Area $= 2 - 0 = 2$.
\end{itemize}
...
\begin{itemize}[nosep]
  ...
  \item Differentiate and set to zero: $A'(x) = \frac{1}{2}\left[\sqrt{1-x^2} + (x+1) \cdot \frac{-x}{\sqrt{1-x^2}}\right] = 0$.
  \item $\sqrt{1-x^2} = \frac{x(x+1)}{\sqrt{1-x^2}} \implies 1-x^2 = x^2 + x \implies 2x^2 + x - 1 = 0$.
  \item $(2x - 1)(x + 1) = 0 \implies x = \frac{1}{2}$ (taking $x \ne -1$).
  \item Area $= \frac{1}{2} \cdot \frac{3}{2} \cdot \sqrt{1 - \frac{1}{4}} = \frac{3}{4} \cdot \frac{\sqrt{3}}{2} = \frac{3\sqrt{3}}{8}$.
\end{itemize}
...
\begin{itemize}[nosep]
  ...
  \item $f(x) = -4x^2(x^2-1) = -4x^4 + 4x^2$. $f(1/\sqrt{2}) = -4 \cdot \frac{1}{4} + 4 \cdot \frac{1}{2} = -1 + 2 = 1$. \checkmark{}
  \item But we can also write $f(x) = 4x^2 - 4x^4$ or $f(x) = 4x^2(1-x^2)$.
  \item Actually looking more carefully: the turning points are at $(\pm 1/\sqrt{2}, 1)$. With $f(x) = ax^4 + bx^2$ (even function touching origin), $f'(x) = 4ax^3 + 2bx = 0$ gives $x = 0$ or $x^2 = -b/(2a)$.
  \item So $f(x) = -4x^4 + 4x^2$.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item $\frac{d}{dx}[e^{3+2x-x^2}] = (2 - 2x)e^{3+2x-x^2}$.
  \item Since $e^{3+2x-x^2} > 0$ always, the sign depends on $2 - 2x$.
  \item $2 - 2x < 0 \implies x > 1$.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item $\frac{d}{dx}[3 + 2e^x - e^{2x}] = 2e^x - 2e^{2x} = 2e^x(1 - e^x) = 0$.
  \item $e^x = 1 \implies x = 0$.
  \item $f(g(0)) = 3 + 2(1) - 1 = 4$.
  \item Stationary point at $(0, 4)$.
\end{itemize}
