  ...
  return (
    <section className="py-16 px-4">
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Free Plan */}
        <div className="rounded-2xl border border-black/10 bg-white p-6 sm:p-8 flex flex-col">
          <div className="mb-6">
            <div className="flex items-center gap-2 mb-2">
              <BookOpen className="w-5 h-5 text-black/40" />
              <h3 className="text-xl font-semibold text-black">Free</h3>
            </div>
            <div className="flex items-baseline gap-1">
              <span className="text-4xl font-bold text-black">$0</span>
              <span className="text-black/45">/forever</span>
            </div>
            <p className="text-black/45 mt-2 text-sm">Get started with the basics</p>
          </div>
          ...
          <button
            ...
            className="w-full py-3 rounded-xl font-medium text-sm border border-black/10 text-black/40 hover:bg-black/[0.02] transition disabled:opacity-50 disabled:cursor-default"
          >
        ...
        {/* Pro Plan */}
        <div className="relative rounded-2xl border border-black/12 bg-white p-6 sm:p-8 flex flex-col">
          <div className="absolute -top-3 right-6 flex items-center gap-1 bg-white border border-black/10 text-black/45 text-xs font-bold px-3 py-1 rounded-full shadow-sm">
          ...
          <div className="mb-6">
            ...
            <p className="text-black/45 mt-2 text-sm">Everything you need to ace your ATAR</p>
          </div>
          ...
          <ul className="space-y-3 mb-8 flex-1">
            {[
              ...
              <li key={f} className="flex items-center gap-2 text-black/55 text-sm">
                <Check className="w-4 h-4 text-black/35 shrink-0" />
                {f}
              </li>
            ))}
          </ul>
          ...
          <button
            ...
            className="w-full py-3 rounded-xl font-medium text-sm bg-black text-white hover:bg-black/85 transition disabled:opacity-40 disabled:cursor-default"
          >
