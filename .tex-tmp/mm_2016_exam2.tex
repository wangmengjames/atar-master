...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item $f(x) = 5 - x$. Range $[-4, 5)$ means $-4 \le 5 - x < 5$, so $0 < x \le 9$. But range includes $-4$ (closed) so $x = 9$ is included; range excludes $5$ so $x = 0$ is excluded. Domain $= (0, 9]$.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item Period $= \frac{2\pi}{\pi/2} = 4$. Range $= [1-2, 1+2] = [-1, 3]$.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item $x$-intercepts: $x = \pm\sqrt{5}$. Positive intercept $(\sqrt{5}, 0)$. $y$-intercept $(0, -5)$. Slope $= \frac{0-(-5)}{\sqrt{5}-0} = \frac{5}{\sqrt{5}} = \sqrt{5}$. Tangent slope: $y' = 2x = \sqrt{5}$, so $x = \frac{\sqrt{5}}{2}$.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item Test $f(x) = \frac{1}{x}$: $\frac{1}{x} - \frac{1}{y} = \frac{y-x}{xy} = (y-x) \cdot \frac{1}{xy} = (y-x)f(xy)$. \checkmark{}
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item Area $= uv = u(4-u^2)$. $A'(u) = 4 - 3u^2 = 0$, $u = \frac{2}{\sqrt{3}}$. $A = \frac{2}{\sqrt{3}}(4 - \frac{4}{3}) = \frac{2}{\sqrt{3}} \cdot \frac{8}{3} = \frac{16}{3\sqrt{3}} = \frac{16\sqrt{3}}{9}$.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item $\Pr(X < a) = \int_{3\pi}^a \frac{1}{4}\cos(x/2)\,dx = \frac{1}{2}[\sin(x/2)]_{3\pi}^a = \frac{1}{2}(\sin(a/2) - \sin(3\pi/2)) = \frac{1}{2}(\sin(a/2)+1)$. Set equal to $\frac{\sqrt{3}+2}{4}$: $\sin(a/2) = \frac{\sqrt{3}}{2}$. For $3\pi \le a \le 5\pi$: $a/2 \in [3\pi/2, 5\pi/2]$. $\sin(a/2) = \sqrt{3}/2$ gives $a/2 = 2\pi + \pi/3 = 7\pi/3$, so $a = 14\pi/3$.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item $T$: $x' = -x$, $y' = 3y + 5$. So $x = -x'$, $y = \frac{y'-5}{3}$. $g(x') = 3f(-x') + 5$. $\int_{-3}^0 g(x)\,dx = \int_{-3}^0 (3f(-x)+5)\,dx$. Let $u = -x$: $= \int_3^0 (3f(u)+5)(-du) = \int_0^3 (3f(u)+5)\,du = 3(5) + 5(3) = 15 + 15 = 30$... Hmm. Let me recheck. $= 3\int_0^3 f(u)\,du + 5 \cdot 3 = 15 + 15 = 30$. But answer should be 20 based on options.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item $f'(x) = 2 \cdot (-\sin(x/2)) \cdot \frac{1}{2} = -\sin\left(\frac{x}{2}\right)$.
\end{itemize}
...
\begin{itemize}[nosep]
  ...
  \item $f'(\pi) = -\sin(\pi/2) = -1$.
  \item $y - \pi = -1(x - \pi)$, i.e., $y = -x + 2\pi$.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item $f'(x) = -\sin(x/2) = 1$, so $\sin(x/2) = -1$.
  \item $x/2 = 3\pi/2 + 2k\pi$, i.e., $x = 3\pi + 4k\pi$.
  \item In $[0, 8\pi]$: $x = 3\pi$ and $x = 7\pi$.
  \item At $x = 3\pi$: $f(3\pi) = 2\cos(3\pi/2) + \pi = \pi$. Tangent: $y = x - 3\pi + \pi = x - 2\pi$.
  \item At $x = 7\pi$: $f(7\pi) = 2\cos(7\pi/2) + \pi = \pi$. Tangent: $y = x - 7\pi + \pi = x - 6\pi$.
\end{itemize}
...
\begin{itemize}[nosep]
  ...
  \item $f(x) = 2\cos(x/2) + \pi$ maps to $y' = a(2\cos((x'-(-\pi)\cdot\frac{1}{2})/2) + \pi) + b = a(2\cos((x'+\pi)/2) + \pi) + b$.
  \item We need this to equal $f'(x') = -\sin(x'/2)$.
...
\begin{itemize}[nosep]
  ...
  \item In $[0, 8\pi]$: $x = \frac{3\pi}{2}, \frac{7\pi}{2}, \frac{11\pi}{2}, \frac{15\pi}{2}$.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item $g'(x) = f(x) = -\frac{1}{3}(x+2)(x-1)^2 = 0$. So $x = -2$ or $x = 1$.
\end{itemize}
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item Tangent at $A$ has gradient $-4/3$, so $g'(x) = f(x) = -\frac{1}{3}(x+2)(x-1)^2 = -\frac{4}{3}$.
  \item $(x+2)(x-1)^2 = 4$. Solve to find $D$ (different from $A$).
  \item $D$ is on the curve, so find $x$ and $g(x)$.
\end{itemize}
