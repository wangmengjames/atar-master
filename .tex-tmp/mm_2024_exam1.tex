...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item Rate is derivative. $h_1
  \item (t)$. Integrating gives $h_1(t) = 0.5 h(t) + c$.
...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item i. Product rule: $f
  \item ,
                
  \item $ is continuous. $f
  \item ,
                
  \item (2\\pi/3) = \\frac{\\sqrt{3}}{2} + \\frac{2\\pi}{3}(-\\frac{1}{2}) = \\frac{\\sqrt{3}}{2} - \\frac{\\pi}{3}$.
  \item Check monotonicity: $f
  \item (x) = 2\\cos(x) - x\\sin(x)$. In Q2 both terms negative, so $f
  \item ,
...
\begin{itemize}[nosep]
  ...
  \item (0) = \\frac{1}{3}(-k)^{-2/3} = \\frac{1}{3} ((-1)^2 k^2)^{-1/3} = \\frac{1}{3k^{2/3}}$.
\end{itemize}
...
\begin{itemize}[nosep]
  \item Set $g
  \item (0)$. $\\frac{1}{3}(x-k)^{-2/3} = \\frac{1}{3}(-k)^{-2/3}$.
  \item $(x-k)^2 = (-k)^2 = k^2$.
  \item $x-k = k$ or $x-k = -k$.
