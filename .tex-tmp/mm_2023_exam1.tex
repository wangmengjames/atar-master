...
\textit{Marking guide:}
\begin{itemize}[nosep]
  \item Quotient rule: $u = x^2 - x$, $v = e^x$, $u
  \item  = e^x$.
...
\begin{itemize}[nosep]
  ...
  \item (\\frac{\\pi}{4}) = e^{\\pi/2}\\left(\\frac{\\sqrt{2}}{2} + 2 \\cdot \\frac{\\sqrt{2}}{2}\\right) = e^{\\pi/2} \\cdot \\frac{3\\sqrt{2}}{2}$.
\end{itemize}
...
\begin{itemize}[nosep]
  \item $f(0) = a - 0 = a = 12$ ✓.
  \item $g(1) = 12 + b = 9 \\Rightarrow b = -3$ ✓.
\end{itemize}
